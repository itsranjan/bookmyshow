...
public class TicketService {
    ...
    private void sendMailToUser(User user, Show show, String seats) {
        ...
        message.setFrom("007samthegreat@gmail.com");
